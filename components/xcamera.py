...
from lib.platform_api import LANDSCAPE, set_orientation, take_picture
...
def check_camera_permission():
    ...
    if not is_android():
        return True
    from android.permissions import Permission, check_permission  # @UnresolvedImport
...
def check_request_camera_permission(callback=None):
    ...
    if not had_permission:
        from android.permissions import Permission, request_permissions  # @UnresolvedImport
